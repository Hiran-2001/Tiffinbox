        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>BiteBox</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <?php if(isset($_SESSION["username"])): ?>
                        ...
                        <div class="dropdown">
                            <a class="btn btn-primary py-2 px-4 dropdown-toggle" href="#" role="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-user me-2"></i><?php echo htmlspecialchars($_SESSION["username"]); ?>
                            </a>
