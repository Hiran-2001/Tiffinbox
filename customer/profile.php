        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Customer Profile</h5>
                        ...
                        <div class="card shadow-lg">
                            <div class="card-header bg-primary text-white">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h4 class="mb-0">
                                            <i class="fa fa-user me-2"></i><?php echo $customer['customername']; ?>
                                        </h4>
                                        <small>Customer ID: #<?php echo $customer['customerid']; ?></small>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <span><?php echo $customer['contactno']; ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <span><?php echo $customer['housename']; ?></span>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <strong class="text-muted d-block">Landmark</strong>
                                        <span><?php echo $customer['landmark']; ?></span>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <strong class="text-muted d-block">Pincode</strong>
                                        <span><?php echo $customer['pincode']; ?></span>
                                    </div>
                                </div>
