                    ...
                    <div class="row align-items-center g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">
                                Welcome back, <?php echo htmlspecialchars($_SESSION["username"]); ?>! Manage your delivery assignments and view available requests.
                            </p>
                        </div>
                        <div class="col-lg-4 text-center">
                            <div class="card bg-light shadow">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <h4 class="text-success mb-0"><?php echo mysqli_num_rows($assignedDeliveries ?? mysqli_query($db->conn, "SELECT 1")); ?></h4>
                                            <small class="text-muted">Assigned</small>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="text-warning mb-0"><?php echo mysqli_num_rows($pendingDeliveries ?? mysqli_query($db->conn, "SELECT 1")); ?></h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span class="badge bg-primary">#<?php echo $delivery['requestid']; ?></span></td>
                                                ...
                                                <td><span class="text-success fw-bold">₹<?php echo $delivery['amount']; ?></span></td>
                                                <td><?php echo date('M d, Y', strtotime($delivery['startdate'])); ?></td>
                                                <td>
                                                    <span class="badge bg-<?php echo $delivery['status'] == 'Paid' ? 'warning' : 'info'; ?>">
                                                        <?php echo $delivery['status']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <button class="btn btn-success btn-sm" onclick="markDelivered(<?php echo $delivery['requestid']; ?>)">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span class="badge bg-secondary">#<?php echo $request['requestid']; ?></span></td>
                                                ...
                                                <td><span class="text-success fw-bold">₹<?php echo $request['amount']; ?></span></td>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary btn-sm" onclick="acceptDelivery(<?php echo $request['requestid']; ?>)">
